...
import KuCoin = require("./gateways/kucoin");
...
const liveTradingSetup = () : SimulationClasses => {
    ...
    const getExchange = (): Models.Exchange => {
        ...
        switch (ex) {
            ...
            case "kucoin": return Models.Exchange.KuCoin;
    ...
    const getExch = (orderCache: Broker.OrderStateCache): Promise<Interfaces.CombinedGateway> => {
        switch (exchange) {
            ...
            case Models.Exchange.KuCoin: return KuCoin.createKuCoinGateway(config, pair);
